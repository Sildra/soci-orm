...
#endif
#ifndef SOCI_ORM_VALUE_FULL
# define SOCI_ORM_VALUE_FULL(CONVERTOR, FIELD, NAME)
#endif
#define SOCI_ORM_VALUE(FIELD, NAME) SOCI_ORM_VALUE_FULL(SOCI_ORM_ACCESSOR::FIELD, FIELD, NAME)
#ifndef SOCI_ORM_INLINE
# define SOCI_ORM_INLINE(FIELD)
#endif
#ifndef SOCI_ORM_PK_FULL
# define SOCI_ORM_PK_FULL(CONVERTOR, FIELD, NAME)
#endif
#define SOCI_ORM_PK(FIELD, NAME) SOCI_ORM_PK_FULL(SOCI_ORM_ACCESSOR::FIELD, FIELD, NAME)
#ifndef SOCI_ORM_FK
