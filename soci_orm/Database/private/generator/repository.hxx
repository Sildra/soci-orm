...
#define SOCI_ORM_PK_FULL(CONVERTOR, FIELD, NAME)        \
        pk_ ## FIELD = Affinity<CONVERTOR>::to_bulk(SOCI_ORM_ACCESSOR::get_ ## FIELD(value));
#define SOCI_ORM_AUTOINDEX(FIELD, NAME)                 \
...
#define SOCI_ORM_PK_FULL(CONVERTOR, FIELD, NAME)    , pk_ ## FIELD
#define SOCI_ORM_AUTOINDEX(FIELD, NAME)             , autoindex_ ## FIELD
#include "soci_xmacro.h"
        ) < std::tie(                               tie_field
#define SOCI_ORM_PK_FULL(CONVERTOR, FIELD, NAME)    , other.pk_ ## FIELD
...
#define SOCI_ORM_COLLECTION(FIELD)                  \
    Repository<SOCI_ORM_ACCESSOR::FIELD::value_type> FIELD;
#include "soci_xmacro.h"
